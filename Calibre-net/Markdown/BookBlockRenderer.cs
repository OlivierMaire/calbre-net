...
/// <summary>
/// A HTML renderer for a <see cref="BookBlock"/>.
/// </summary>
/// <seealso cref="HtmlObjectRenderer{BookBlock}" />
public class BookBlockRenderer(BookService bookService) : HtmlObjectRenderer<BookBlock>
{
    private readonly BookService _bookService = bookService;

// RenderFragment frag(BookDto book) => @"<Calibre_net.Client.Pages.Shared.BookThumb CalibreBook="@book" />";
    ...
    public Action<HtmlRenderer, BookDto> RenderBook { get; set; } = DefaultRenderBook;


    /// <inheritdoc />
    protected override void Write(HtmlRenderer renderer, BookBlock obj)
    {
        if (!int.TryParse(obj.BookId.AsSpan(), out var bookId))
            return;
    ...
    public static void DefaultRenderBook(HtmlRenderer renderer, BookDto book)
    {

        var bookJson = JsonSerializer.Serialize(book);

        string bookComponent = @"<BookThumb CalibreBook=""@book""/>";
        string? html = $"""
    <div>
         Book ID : {book.Id} <br/>
         {book.Title}

        <BookThumb CalibreBook='{bookJson}'/>
    </div>
""";
        ...
        // builder.OpenComponent<Calibre_net.Client.Pages.Shared.BookThumb>(0);
        // builder.AddAttribute(1, "CalibreBook", book);
        ...
        //     // _ => null
        //     _ => "<p class=\"markdown-alert-title\"><svg viewBox=\"0 0 16 16\" version=\"1.1\" width=\"16\" height=\"16\" aria-hidden=\"true\"><path d=\"M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Zm8-6.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13ZM6.5 7.75A.75.75 0 0 1 7.25 7h1a.75.75 0 0 1 .75.75v2.75h.25a.75.75 0 0 1 0 1.5h-2a.75.75 0 0 1 0-1.5h.25v-2h-.25a.75.75 0 0 1-.75-.75ZM8 6a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z\"></path></svg>Note</p>",
